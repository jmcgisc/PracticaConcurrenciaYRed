...
extension TopicsCoordinator: TopicsCoordinatorDelegate {
    func didSelect(topic: Topic) {
        ...
        let topicsDetailViewController = TopicDetailViewController(viewModel: topicDetailViewModel)
        topicsDetailViewController.title = NSLocalizedString("Details", comment: "")
        topicDetailViewModel.viewDelegate = topicsDetailViewController
        topicDetailViewModel.coordinatorDelegate = self
        self.topicDetailViewModel = topicDetailViewModel
        presenter.pushViewController(topicsDetailViewController, animated: false)
